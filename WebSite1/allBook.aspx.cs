...
public partial class allBook : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        while (data.Read())
        {
            ...
            hy = new HyperLink();
            hy.Text = (i + 1).ToString() + ":" + data["Book_Name"].ToString();
            hy.NavigateUrl = "./book.aspx" + "?id=" + data["Book_ID"].ToString();
            hy.Width = 1150;
            hy.Target = "_blank";
            Panel5.Controls.Add(ima);
            Panel5.Controls.Add(hy);
            HtmlGenericControl hgc = new HtmlGenericControl("br");
            Panel5.Controls.Add(hgc);
            i++;
        }
    ...
    {
        Response.Redirect("./login.aspx?last_url=./allBook.aspx");
    }
